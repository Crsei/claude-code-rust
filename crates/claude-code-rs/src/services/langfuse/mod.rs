...
#[cfg(feature = "telemetry")]
pub use tracing::{
    LangfuseSpan, LangfuseTrace, TraceStatus, create_generation_span, create_subagent_trace,
    create_tool_batch_span, create_tool_span, create_trace, end_span, end_trace,
    finish_generation_span, finish_tool_span,
};
...
pub use stub::{
    LangfuseSpan, LangfuseTrace, TraceStatus, create_generation_span, create_subagent_trace,
    create_tool_batch_span, create_tool_span, create_trace, end_span, end_trace,
    finish_generation_span, finish_tool_span, shutdown_langfuse,
};
