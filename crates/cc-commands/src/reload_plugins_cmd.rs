...
pub struct ReloadPluginsRuntime {
    ...
    pub discover_plugin_skills: fn() -> Vec<cc_skills::SkillDefinition>,
}
...
fn format_report(report: &ReloadReport, skill_report: &cc_skills::SkillLoadReport) -> String {
    let mut out = format!(
...
mod tests {
    ...
    fn discover_plugin_skills() -> Vec<cc_skills::SkillDefinition> {
        Vec::new()
    }
