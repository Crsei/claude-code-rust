...
use cc_engine::status_line::payload::{build_payload_from_snapshot, StatusLineSnapshot};
use cc_engine::status_line::{StatusLineOutput, StatusLinePayload, StatusLineRunner};
...
fn command_worktree_status() -> Option<cc_engine::status_line::payload::WorktreeStatus> {
