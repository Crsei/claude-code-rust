...
//! core telemetry pipeline (cc-observability audit log + cc-services
//! TelemetryHandle) is stable and the benefits of Perfetto export are
//! validated against real usage patterns.
//!
//! See: docs/utils/telemetry-observability.md § "Postponed / Non-P0"
