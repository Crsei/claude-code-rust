...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run workspace crate extraction batches.")
    parser.add_argument(
        "--tasks-file",
        default="docs/scripts/workspace-crate-extraction-omx-tasks-2026-05-10.txt",
    )
    ...
    parser.add_argument(
        "--output-root",
        default="target/codex-runs/workspace-crate-extraction-omx",
    )
...
def run(args: argparse.Namespace) -> int:
    ...
    print()
    print(f"Workspace crate extraction run finished. Artifacts: {output_root}")
...
def run_batch(
    ...
    print()
    print(
        f"=== Workspace crate extraction batch {batch_label} "
