...
| WebFetch | JS 渲染、Cookie 管理、代理支持、Content-Type 智能处理；redirect budget / cross-host redirect diagnostic 子项已落地 |
...
4. **WebFetch browser-grade 能力**：按 `architecture/mvp-optimization-plans/MVP-009-web-fetch-browser-grade-plan.md` 逐步补 JS 渲染、Cookie jar、代理与 Content-Type 智能处理；redirect budget / cross-host redirect diagnostic 已完成。
