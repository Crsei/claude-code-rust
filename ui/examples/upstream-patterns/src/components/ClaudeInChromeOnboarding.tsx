...
const CHROME_EXTENSION_URL = 'https://placeholder.invalid/chrome'
const CHROME_PERMISSIONS_URL = 'https://placeholder.invalid/chrome/permissions'
    ...
    >
      <Box flexDirection="column" gap={1}>
        ...
        <Text dimColor>
          ...
          or visit <Link url="https://placeholder.invalid/docs/en/chrome" />
        </Text>
      </Box>
    </Dialog>
  )
