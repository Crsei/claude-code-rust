...
| --- | --- | --- | --- |
| `compaction.mdx` | [`cc-compact/src/pipeline.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/pipeline.rs#L65), [`cc-compact/src/session_memory_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/session_memory_compact.rs), [`cc-compact/src/compaction.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/compaction.rs#L99), [`cc-compact/src/partial_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/partial_compact.rs), [`cc-compact/src/gates.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/gates.rs), [`claude-code-rs/src/query/loop_helpers.rs`](F:/AIclassmanager/cc/rust/crates/claude-code-rs/src/query/loop_helpers.rs#L202) | 部分实现 | 本地压缩、Microcompact Boundary、Session Memory Compact、boundary、手动 `/compact` / Session Memory Compact / 自动模型摘要 / 内部 snip/context-collapse preservedSegment 元数据、PTL 恢复、hook、显式 compaction gates 和 Partial Compact 核心 primitive 已有；Partial Compact 命令/UI anchor 选择面与完整 resume/export e2e 仍未完全同构。 |
...
- `部分实现`。
- 原因不是“没有压缩”，而是压缩主链路、Microcompact Boundary、Session Memory Compact、手动 `/compact` boundary、Session Memory Compact boundary、自动模型摘要 boundary、内部 snip/context-collapse boundary、显式 compaction gates 和 Partial Compact 核心 primitive 都已经存在；差异点在于 Partial Compact 的 command/UI anchor 选择面、resume/export e2e 和某些恢复策略仍没有完整的一一对应。
...
- 压缩主链路已经实现：tool result budget、snip、microcompact、Microcompact Boundary、Session Memory Compact、自动压缩、boundary、preservedSegment、PTL 恢复、hook、显式 compaction gates 和 Partial Compact 核心 primitive 都有对应代码。[`pipeline.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/pipeline.rs#L65), [`microcompact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/microcompact.rs#L26), [`session_memory_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/session_memory_compact.rs), [`compaction.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/compaction.rs#L188), [`snip.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/snip.rs#L87), [`context_collapse.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/context_collapse.rs#L81), [`partial_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/partial_compact.rs), [`gates.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/gates.rs)
...
- `compaction.mdx`：已有完整压缩管线、Microcompact Boundary、Session Memory Compact、手动 `/compact` boundary、Session Memory Compact boundary、自动模型摘要 boundary、内部 snip/context-collapse boundary preservedSegment 元数据、显式 compaction gates 和 Partial Compact 核心 primitive；Partial Compact 的 command/UI anchor 选择面、resume/export e2e 与完整恢复语义还没有完全同构。[`pipeline.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/pipeline.rs#L65), [`microcompact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/microcompact.rs#L26), [`session_memory_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/session_memory_compact.rs#L87), [`compact.rs`](F:/AIclassmanager/cc/rust/crates/claude-code-rs/src/commands/compact.rs#L67), [`compaction.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/compaction.rs#L188), [`snip.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/snip.rs#L87), [`context_collapse.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/context_collapse.rs#L81), [`partial_compact.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/partial_compact.rs), [`gates.rs`](F:/AIclassmanager/cc/rust/crates/cc-compact/src/gates.rs)
